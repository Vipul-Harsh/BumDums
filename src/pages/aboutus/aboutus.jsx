              ...
              <div className="single-food text-center">
                ...
                <span className="g-s-4">
                  <img
                    ...
                    alt=""
                    style={{ opacity: "0.25", filter: "brightness(0)" }}
                  />
                </span>
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-12  wow fadeInRight">
              <div className="about-right">
                ...
                <h2>
                  About Bumdum: A Culinary Odyssey 
                  <span>{' '}Embark on a Flavorful Journey.</span>
                </h2>
                <p>
                  Bumdum is not just a restaurant; it&apos;s a culinary adventure.
                  Situated in the vibrant heart of Bhiwadi, Bumdum is more than
                  just a dining destination – it&apos;s an experience. Our passion
                  for food drives us to deliver exceptional dishes, from
                  traditional recipes to innovative creations, all served with a
                  touch of flair.
                </p>
    ...
    <div className="tab-content" id="historyTabContent">
        ...
        >
            <div className="his-content">
                <p>
                    Bumdum is a culinary haven, offering a delightful array of fast food delights including burgers, fries, milkshakes, and more.
                </p>
        ...
        >
            <div className="his-content">
                <p>
                    Bumdum is renowned for its mouthwatering burgers, fries, milkshakes, and more. We take pride in delivering superior quality and delicious taste.
                </p>
                <div className="sig-wrapper d-flex flex-wrap justify-content-around align-items-center">
                    <div className="sig-img d-flex align-items-center">
                        <img src="/assets/images/icons/sig.png" alt="" />
        ...
        >
            <div className="his-content">
                <p>
                    Bumdum is not just a restaurant, it&apos;s an experience. Located in the bustling heart of Bhiwadi, Bumdum offers a delightful selection of culinary delights to tantalize your taste buds.
                </p>
                <div className="sig-wrapper d-flex flex-wrap justify-content-around align-items-center">
                    <div className="sig-img d-flex align-items-center">
                        <img src="/assets/images/icons/sig.png" alt="" />
