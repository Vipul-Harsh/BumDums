            ...
            <section className="menu-area  pizza-area burger-area chicken-area padding-top-40">
                ...
                <div className="container">
                    <div className="common-title-area text-center padding-40">
                        ...
                        <h2>
                            {TrimWord(menuData?.section1.title)?.[0]} <span> {TrimWord(menuData?.section1.title)?.[1]}</span>{" "}
                        </h2>
                    </div>
                    {/* menu-nav-wrapper */}
                        ...
                        <div className="container">
                            <div className="row">
                                <ul className="nav" id="myTab" role="tablist">
                                    {/* menu-nav-1 */}
                                    {menuData?.section1?.categories?.map((category, index) => <><li className="nav-item" role="presentation">
                                        <div
                                        ...
                                        >
                                            <div className="single-menu-nav pizza-single-menu-nav  text-center">
                                                <div className="menu-img margin-bottom-10">
                                                    <img src={menuData?.section2?.image ? menuData?.section2?.image : "/assets/images/menu-item/tc1.png"} alt="" />
                                                </div>
                                                <h6>{category}</h6>
                                ...
                                <div className="menu-items-wrapper pizza-items-wrapper  margin-top-50">
                                    <div className="row">
                                        <div className="col-lg-8">
                                            <div className="row">
                                                {menuData?.section1?.menu?.filter(item => item.category === category)?.map(item => <>
                                                    <div className="col-lg-6 col-md-6">
                                                        <div className="single-menu-item d-flex justify-content-between">
                                                            <div className="menu-img">
                                                                <img src={item?.image ? item?.image : "/assets/images/menu-item/tc6.png"} alt="" />
                                                            </div>
            ...
            <section className="menu-area  pizza-area burger-area padding-top-40">
                ...
                <div className="container">
                    <div className="common-title-area text-center padding-40">
                        ...
                        <h2>
                            {TrimWord(menuData?.section2.title)?.[0]} <span> {TrimWord(menuData?.section2.title)?.[1]}</span>{" "}
                        </h2>
                    </div>
                    {/* menu-nav-wrapper */}
                    <div className="menu-nav-wrapper">
                                    ...
                                    {menuData?.section2?.categories?.map((category, index) => <>
                                        <li className="nav-item" role="presentation">
                                            ...
                                            >
                                                <div className="single-menu-nav pizza-single-menu-nav  text-center">
                                                    <div className="menu-img margin-bottom-10">
                                                        <img src={menuData?.section2?.image ? menuData?.section2?.image : "/assets/images/menu-item/bn1.png"} alt="" />
                                                    </div>
                                                    <h6>{category}</h6>
                                                    <span className="g-s-4">
                                                        <img src="/assets/images/shapes/10.png" alt="" />
                    ...
                    <div className="tab-content" id="nav-tabContent1">
                        ...
                        {menuData?.section2?.categories?.map((category, index) => <>
                            ...
                            >
                                <div className="menu-items-wrapper pizza-items-wrapper  margin-top-50">
                                    <div className="row">
                                        {menuData?.section2?.menu?.filter(item => item.category === category)?.map(item => <>
                                            <div className="col-lg-4 col-md-4">
                                                <div className="single-menu-item d-flex justify-content-between">
                                                    <div className="menu-img">
                                                        <img src={item?.image ? item?.image : "/assets/images/menu-item/br2.png"} alt="" />
                                                    </div>
                                                    <div className="menu-content">
                                                        <h6>
                                                            <a href="single-dish.html">{item?.name}</a>
            ...
            <section className="menu-area  pizza-area">
                ...
                <div className="container">
                    <div className="common-title-area text-center padding-40">
                        ...
                        <h2>
                            {TrimWord(menuData?.section3.title)?.[0]} <span> {TrimWord(menuData?.section3.title)?.[1]}</span>{" "}
                        </h2>
                    </div>
                    {/* menu-nav-wrapper */}
                    <div className="menu-nav-wrapper">
                        <div className="container">
                            <div className="row">
                                <ul className="nav" id="pizzaTab2" role="tablist">
                                    {/* menu-nav-1 */}
                                    {menuData?.section3?.categories?.map((category, index) => <><li className="nav-item" role="presentation">
                                        <div
                                            className={`nav-link ${!index && 'active'}`}
                                            id={`nav-${category}-${index}`}
                                            data-bs-toggle="tab"
                                        ...
                                        >
                                            <div className="single-menu-nav pizza-single-menu-nav  text-center">
                                                <div className="menu-img margin-bottom-10">
                                                    <img src={menuData?.section3?.image ? menuData?.section3?.image : "/assets/images/menu-item/pm1.png"} alt="" />
                                                </div>
                                                <h6>{category}</h6>
                                                <span className="g-s-4">
                                                    <img src="/assets/images/shapes/10.png" alt="" />
                    ...
                    <div className="tab-content" id="nav-tabContent2">
                        {/* menu-items-1 */}
                        {menuData?.section3?.categories?.map((category, index) => <><div
                            className={`tab-pane fade ${!index && 'show active'}`}
                            id={`${category}-${index}`}
                            role="tabpanel"
                            aria-labelledby={`nav-${category}-${index}`}
                        >
                            <div className="menu-items-wrapper pizza-items-wrapper  margin-top-50">
                                <div className="row">
                                    {menuData?.section3?.menu?.filter(item => item.category === category)?.map(item => <>
                                        <div className="col-lg-4 col-md-4">
                                            <div className="single-menu-item d-flex justify-content-between">
                                                <div className="menu-img">
                                                    <img src={item?.image ? item?.image : "/assets/images/menu-item/piz1.png"} alt="" />
                                                </div>
                                                <div className="menu-content">
                                                    <h6>
                                                        <a href="single-dish.html">{item?.name}</a>
            ...
            <section className="menu-area  pizza-area">
                ...
                <div className="container">
                    <div className="common-title-area text-center padding-40">
                        ...
                        <h2>
                            {TrimWord(menuData?.section4.title)?.[0]} <span> {TrimWord(menuData?.section4.title)?.[1]}</span>{" "}
                        </h2>
                    </div>
                    {/* menu-nav-wrapper */}
                    <div className="menu-nav-wrapper">
                        <div className="container">
                            <div className="row">
                                <ul className="nav" id="pizzaTab2" role="tablist">
                                    {/* menu-nav-1 */}
                                    {menuData?.section4?.categories?.map((category, index) => <><li className="nav-item" role="presentation">
                                        <div
                                            className={`nav-link ${!index && 'active'}`}
                                            id={`nav-${category}-${index}`}
                                            data-bs-toggle="tab"
                                        ...
                                        >
                                            <div className="single-menu-nav pizza-single-menu-nav  text-center">
                                                <div className="menu-img margin-bottom-10">
                                                    <img src={menuData?.section4?.image ? menuData?.section4?.image : "/assets/images/menu-item/pm1.png"} alt="" />
                                                </div>
                                                <h6>{category}</h6>
                                                <span className="g-s-4">
                                                    <img src="/assets/images/shapes/10.png" alt="" />
                    ...
                    <div className="tab-content" id="nav-tabContent2">
                        {/* menu-items-1 */}
                        {menuData?.section4?.categories?.map((category, index) => <><div
                            className={`tab-pane fade ${!index && 'show active'}`}
                            id={`${category}-${index}`}
                            role="tabpanel"
                            aria-labelledby={`nav-${category}-${index}`}
                        >
                            <div className="menu-items-wrapper pizza-items-wrapper  margin-top-50">
                                <div className="row">
                                    {menuData?.section4?.menu?.filter(item => item.category === category)?.map(item => <>
                                        <div className="col-lg-4 col-md-4">
                                            <div className="single-menu-item d-flex justify-content-between">
                                                <div className="menu-img">
                                                    <img src={item?.image ? item?.image : "/assets/images/menu-item/piz1.png"} alt="" />
