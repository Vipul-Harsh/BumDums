...
const Home3 = () => {
    return (
        <>
            ...
            <header className="header3">
                ...
                <div className="header-bottom home2-header-bottom margin-top-20">
                    <div className="container position-relative">
                        ...
                        {/* mobile-menu */}
                        <div className="mobile-menu home2 home3-mobile-menu" />
                    </div>
                </div>
            </header>
            {/* snack section */}
                            ...
                            <div className="snack-left margin-bottom-60">
                                ...
                                <div className="snack-lower-content common-title-area">
                                    <h1>
                                        Snack time
                                        <br />
                                        heals <span>all wounds</span>
                                    </h1>
                                    <div className="order-box2 d-flex align-items-center flex-wrap justify-content-center justify-content-sm-start margin-top-35">
                                        <div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 wow fadeInRight">
                            <div className="softdrink-right">
                                <h2>
                                    Softdrink Help Your Harmoneuous &amp;
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div className="single-timeline">
                                ...
                                <h6>Journey now</h6>
                                <p>
                                    FoodKhan Softdrink Open! Get your and enjoy some festive for
                                    yourself!
                                </p>
                            </div>
                        </div>
            ...
            <section className="drink-items-section padding-bottom-120 padding-top-110">
                ...
                <div className="container">
                    <div className="common-title-area3 text-center padding-bottom-50 wow fadeInUp">
                        <h2>
                            Explore Our <span>Bottles &amp; Cans</span>{" "}
                        </h2>
                    </div>
                    <div className="row">
                        <div
                            className="col-xl-3 col-lg-3 col-md-6 wow fadeIn"
                            data-wow-delay=".2s"
                        >
                            <div className="single-dishes home3-single-dishes">
                                ...
                                <div className="dish-content">
                                    <h5>
                                        <a href="single-dish.html">Gunna Can</a>
                                    </h5>
                        ...
                        >
                            <div className="single-dishes home3-single-dishes">
                                ...
                                <div className="dish-content">
                                    <h5>
                                        <a href="single-dish.html">Dr Pepper Can</a>
                                    </h5>
                                    <p>It is a long established fact that a reader BBQ Chicken.</p>
                                    <span className="price">price :$50.00</span>
                                </div>
                        ...
                        >
                            <div className="single-dishes home3-single-dishes">
                                ...
                                <div className="dish-content">
                                    <h5>
                                        <a href="single-dish.html">Ocem Blue</a>
                                    </h5>
                                    <p>It is a long established fact that a reader BBQ Chicken.</p>
                                    <span className="price">price :$50.00</span>
                                </div>
                        ...
                        >
                            <div className="single-dishes home3-single-dishes">
                                ...
                                <div className="dish-content">
                                    <h5>
                                        <a href="single-dish.html">Calyps Ocem</a>
                                    </h5>
                                    <p>It is a long established fact that a reader BBQ Chicken.</p>
                                    <span className="price">price :$50.00</span>
                                </div>
                        ...
                        <div className="mx-auto margin-top-30">
                            <a href="food-page.html" className="btn2">
                                See All Cans
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="col-lg-6 wow fadeInRight">
                            <div className="drink-ind-right">
                                <div className="common-title-area3 text-center text-md-start">
                                    <h2>
                                        Best Ingredients Food Juices<span> On Right Handmade</span>{" "}
                                    </h2>
                                </div>
                            ...
                            <div className="food-brand-left text-center text-md-start">
                                <div className="common-title-area3">
                                    <h2 className="margin-bottom-20">
                                        Brand Iced Green Tea Lemon <span>Juice Food Included</span>{" "}
                                    </h2>
                                    <p>
            ...
            <div className="ht-testi padding-bottom-120 padding-top-110">
                ...
                <div className="container">
                    <div className="common-title-area3 text-center text-md-start wow fadeInUp">
                        <h2 className="margin-bottom-60 text-center">
                            happy <span>feedback</span>
                        </h2>
                    </div>
            ...
            {/* ToTop Button */}
            <button className="scrollup scrollup2">
