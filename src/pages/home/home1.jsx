                        ...
                        <div className="col-lg-6 col-md-12 offset-lg-1 wow fadeInRight">
                            <div className="about-right">
                                ...
                                <p>
                                    ...
                                    corner site in Farringdons Exmouth Market. With glazed.
                                </p>
                    ...
                    <div className="tab-content" id="nav-tabContent">
                        ...
                        >
                            <div className="menu-items-wrapper menu-custom-padding margin-top-50">
                                ...
                                <hr />
                                {/* second-row */}
                                <div className="row row-gap-4 margin-top-60">
                                    <div className="col-lg-4 col-md-4">
                                        <div className="single-menu-item d-flex justify-content-between align-items-center h-100">
                                            <div className="menu-img">
                                ...
                                <div className="row margin-top-60">
                                    <div className="col-lg-4 col-md-4">
                                        <div className="single-menu-item d-flex justify-content-between align-items-center h-100">
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">BBQ Burger</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                            </div>
                                    ...
                                    <div className="col-lg-4 col-md-4">
                                        <div className="single-menu-item d-flex justify-content-between align-items-center h-100">
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">Chicken Grill</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                                <span className="del">
                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-md-4">
                                        <div className="single-menu-item d-flex justify-content-between">
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">Fried Chicken</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                            </div>
                                    ...
                                    <div className="col-lg-4 col-md-4">
                                        <div className="single-menu-item d-flex justify-content-between align-items-center h-100">
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">Bbq Chicken</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                                <span className="del">
                                ...
                                <div className="row margin-top-60">
                                    <div className="col-lg-4 col-md-4">
                                        <div className="single-menu-item d-flex justify-content-between align-items-center h-100">
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">naga</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                            </div>
                        ...
                        "
                                        >
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html"> Grapefruit</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                            </div>
                        ...
                        "
                                        >
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">Blueberry</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                            </div>
                        ...
                        "
                                        >
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">Cranberry</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                                <span className="del">
                        ...
                        "
                                        >
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">Orange Juice</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                            </div>
                        ...
                        "
                                        >
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">Beet Juice</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                            </div>
                        ...
                        "
                                        >
                                            ...
                                            <div className="menu-content">
                                                <h5>
                                                    <a href="single-dish.html">Pomegranate</a>
                                                </h5>
                                                <p>shirmp. squid, pineapple</p>
                                                <span>price :$15.00</span>
                                                <span className="del">
                        ...
                        <div className="col-lg-5 offset-lg-1 col-md-12 col-sm-12 col-12">
                            <div className="countdown-right">
                                <div className="common-title-area padding-bottom-20">
                                    <h3>coming soon</h3>
                                    <h2>
                                        Spicy Chicken Pizza <span>Food </span>
                                    </h2>
